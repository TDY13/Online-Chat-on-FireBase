...
extension RegistrationViewController: AuthenticationControllerProtocol {
    func checkFormStatus() {
        if viewModel.formIsValid {
            ...
            signUpButton.backgroundColor = UIColor(red: 255/255, green: 99/255, blue: 99/255, alpha: 1)
        } else {
            signUpButton.isEnabled = false
            signUpButton.backgroundColor = UIColor(red: 255/255, green: 99/255, blue: 99/255, alpha: 0.5)
        }
    }
}
